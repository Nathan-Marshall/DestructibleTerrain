...
{
    public class DestructibleObjectPolygonClippingPolyPartitionHMCollider_PolyPartitionEarClippingTriangulator : DestructibleObjectPolygonClippingPolyPartitionHMCollider
    {
