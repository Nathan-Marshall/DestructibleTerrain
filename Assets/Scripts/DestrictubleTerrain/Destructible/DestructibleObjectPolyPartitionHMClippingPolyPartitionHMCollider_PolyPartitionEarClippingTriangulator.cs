...
{
    public class DestructibleObjectPolyPartitionHMClippingPolyPartitionHMCollider_PolyPartitionEarClippingTriangulator : DestructibleObjectPolyPartitionHMClippingCustomHMCollider
    {
