...
{
    public class DestructibleObjectCustomHMClippingCustomHMCollider_PolyPartitionEarClippingTriangulator : DestructibleObjectCustomHMClippingCustomHMCollider
    {
